...
lcd.begin(16,2);
...

  {
    ...
    lcd.print("Electronic Voting Machine");
      ...
      flag=0;
...

        {
...

          {
             ...
             EEPROM.write(i+10, 0xff); // don't want to register again and again?????????
        ...
        lcd.print("Already Voted/Unauthorized");
...

   {
    ...
    lcd.setCursor(0,1);
...

     {
          ...
          {
            Serial.println("prom_loop_out_:");
            Serial.println(EEPROM.read(i+10));
            if(EEPROM.read(i+10) == 0) ///// original condition was EEPROM.read(i+10)== xFF, had to change it to enter into the loop & store the id 
